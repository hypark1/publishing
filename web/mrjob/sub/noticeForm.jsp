							...
							<tr>
								...
								<td>
									<div class="file_input">
										<input type="text" id="filename" disabled="disabled" value="" style="width: 760px;">
										<input type="file" name="upload1" style="display:none;" value="" onchange="javacript:document.getElementById('filename').value=this.value">
									</div>
									<span class="file_btn">
										<a href="javascript:uploadFile()">찾아보기</a>
									</span>
								</td>
							</tr>
							<tr>
