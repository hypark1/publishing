...
<div id="wrapper">
	...
	<div id="section_sub_wrap">
		...
		<div class="sub_content sub_counseling">
			<div class="table_com counseling_table">
				<table cellpadding="0" cellspacing="0">
					<caption>1:1 상담게시판 테이블</caption>
					<colgroup>
					   <col width="130"> 
					   <col width="">
					   <col width="130">
					...
					<tbody>
						<tr><td colspan="4" class="not_found">게시글이 없습니다.</td></tr>
					</tbody>
				</table>
			</div><!-- //table_com -->
			<div class="notice_bot">
				...
				<div class="notice_bot_btn">
					<a href="${pageContext.request.contextPath}/test/miraejob/sub/counselingForm.jsp">등록</a>
				</div><!-- //notice_bot_btn -->
			</div><!-- //notice_bot -->
		</div><!-- //sub_content -->
	</div><!-- //section_wrap -->
